                                            ...
                                            sai_port_pool_stat_t *sai_stat_id)
{
    ...
    {
        {BASE_QOS_PORT_POOL_STAT_GREEN_DISCARD_DROPPED_PACKETS, SAI_PORT_POOL_STAT_GREEN_WRED_DROPPED_PACKETS},
        {BASE_QOS_PORT_POOL_STAT_GREEN_DISCARD_DROPPED_BYTES, SAI_PORT_POOL_STAT_GREEN_WRED_DROPPED_BYTES},
        {BASE_QOS_PORT_POOL_STAT_YELLOW_DISCARD_DROPPED_PACKETS, SAI_PORT_POOL_STAT_YELLOW_WRED_DROPPED_PACKETS},
        {BASE_QOS_PORT_POOL_STAT_YELLOW_DISCARD_DROPPED_BYTES, SAI_PORT_POOL_STAT_YELLOW_WRED_DROPPED_BYTES},
        {BASE_QOS_PORT_POOL_STAT_RED_DISCARD_DROPPED_PACKETS, SAI_PORT_POOL_STAT_RED_WRED_DROPPED_PACKETS},
        {BASE_QOS_PORT_POOL_STAT_RED_DISCARD_DROPPED_BYTES, SAI_PORT_POOL_STAT_RED_WRED_DROPPED_BYTES},
        {BASE_QOS_PORT_POOL_STAT_DISCARD_DROPPED_PACKETS, SAI_PORT_POOL_STAT_WRED_DROPPED_PACKETS},
        {BASE_QOS_PORT_POOL_STAT_DISCARD_DROPPED_BYTES, SAI_PORT_POOL_STAT_WRED_DROPPED_BYTES},
